...
describe('QuickTour component', () => {
    ...
    it('should call goToStep on stepNumber click', () => {
        const props = getProps();
        const stepSpy = sinon.spy(QuickTourSection.prototype, 'goToStep');
        const wrapper = getWrapper(props);
    ...
    it('ChevronLeft should call previousStep when clicked', () => {
        const props = getProps();
        const prevSpy = sinon.spy(QuickTourSection.prototype, 'previousStep');
        const wrapper = getWrapper(props);
    ...
    it('ChevronRight should call nextStep when clicked', () => {
        const props = getProps();
        const nextSpy = sinon.spy(QuickTourSection.prototype, 'nextStep');
        const wrapper = getWrapper(props);
    ...
    it('mediaContainer div should call setArrowVisiblity(true) on mouseEnter', () => {
        const props = getProps();
        const spy = sinon.spy(QuickTourSection.prototype, 'setArrowVisibility');
        const wrapper = getWrapper(props);
    ...
    it('nextStep should increment or return to 0', () => {
        const props = getProps();
        const stateSpy = sinon.spy(QuickTourSection.prototype, 'setState');
        const wrapper = getWrapper(props);
